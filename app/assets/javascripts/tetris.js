Highlight = function(newTilesArray) {
  gameTetris.highlightTiles(newTilesArray);
  setTimeout(function(){gameTetris.clearTiles(newTilesArray)}, 500);
}
...
function TetrisController() {
  ...
  this.cleanTilesArray = function(tilesArray) {
  ...
  this.makeTilesFall = function(tilesArray) {
    newTilesArray = this.cleanTilesArray(tilesArray)
